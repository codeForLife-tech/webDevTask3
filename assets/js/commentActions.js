function postComment(button, postedBy, articleId, replyTo, containerClass) {
    ...
    var n=Number(res)+1;
    $(".commentCount").text(n+" Comments");
    if(commentText) {

        $.post("ajax/postComment.php", { commentText:commentText, postedBy:postedBy, articleId:articleId, responseTo: replyTo})
...
function likeComment(commentId, button, articleId) {
    $.post("ajax/likeComment.php", {commentId:commentId, articleId: articleId})
...
function dislikeComment(commentId, button, articleId) {
    $.post("ajax/dislikeComment.php", {commentId:commentId, articleId: articleId})
    .done(function(numToChange) {
...
function getReplies(commentId, button, articleId) {
    $.post("ajax/getCommentReplies.php", {commentId: commentId, articleId:articleId})
