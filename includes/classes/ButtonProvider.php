...
class ButtonProvider {
    ...
    public static function createEditArticleButton($articleId) {
        $href="editArticle.php?articleId=$articleId";

        $button=ButtonProvider::createHyperlinkButton("EDIT ARTICLE", null, $href, "edit button");

        return "<div class=editArticleButtonContainer>
            $button
        </div>";
    }
